...
const jsonStringify = fs.readFileSync(path.join(__dirname, './jsonify/stringify.js')).toString()
const jsonParse = fs.readFileSync(path.join(__dirname, './jsonify/parse.js')).toString()
